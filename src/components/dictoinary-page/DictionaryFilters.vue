  ...
  <div class="flex flex-wrap gap-4 items-center">
    <div class="relative w-full md:w-auto">
      <select :value="sortOption" @change="handleChange"
        class="cursor-pointer appearance-none w-full md:w-64 px-4 py-2 pr-10 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#A9A8FD] focus:border-transparent">
